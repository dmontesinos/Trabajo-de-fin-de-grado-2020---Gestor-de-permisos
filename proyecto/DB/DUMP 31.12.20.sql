...
(1, 'Test i qualitat', 102758, 3),
(2, 'prueba2', 115, 1),
(4, 'Director', 115, 1),
(5, 'Test-Porfidio Director', 1001048, 6),
(6, 'Prueba de grupo', 415, 5),
(7, 'Prueba Departamento', 472, 4);
...
(5, 'App\\Models\\User', 2, 'gestor-permisos', '5e2d9d2dd5ed2f2d4777e89493b5d5ee0564cd9d71b975f70d8c6b7b8e4527ad', '[\"*\"]', '2020-12-31 10:45:23', '2020-12-31 07:23:14', '2020-12-31 10:45:23');
...
ALTER TABLE `asignaturas_has_estudios`
  ADD PRIMARY KEY (`Asignaturas_idAsignaturas`,`Estudios_idEstudios`,`Estudio_Centros_idCentros`),
  ADD KEY `fk_Asignaturas_has_Grados_Grados1_idx` (`Estudios_idEstudios`,`Estudio_Centros_idCentros`),
  ADD KEY `fk_Asignaturas_has_Grados_Asignaturas1_idx` (`Asignaturas_idAsignaturas`);

--
-- Indexes for table `cargos`
--
ALTER TABLE `cargos`
  ADD PRIMARY KEY (`idCargos`,`Ambitos_idAmbitos`),
  ADD KEY `fk_Cargos_Ambitos1_idx` (`Ambitos_idAmbitos`);

--
-- Indexes for table `cargos_has_profesores`
--
ALTER TABLE `cargos_has_profesores`
  ADD PRIMARY KEY (`Cargos_idCargos`,`Profesores_niu`),
  ADD KEY `fk_Cargos_has_Profesores_Profesores1_idx` (`Profesores_niu`),
  ADD KEY `fk_Cargos_has_Profesores_Cargos1_idx` (`Cargos_idCargos`);
...
ALTER TABLE `departamentos_has_profesores`
  ADD PRIMARY KEY (`Departamentos_idDepartamentos`,`Profesores_niu`),
  ADD KEY `fk_Departamentos_has_Profesores_Profesores1_idx` (`Profesores_niu`),
  ADD KEY `fk_Departamentos_has_Profesores_Departamentos1_idx` (`Departamentos_idDepartamentos`);

--
-- Indexes for table `estudios`
--
ALTER TABLE `estudios`
  ADD PRIMARY KEY (`idEstudio`,`Centros_idCentros`),
  ADD KEY `fk_Grados_Facultades1_idx` (`Centros_idCentros`);
...
--
ALTER TABLE `grupo`
  ADD PRIMARY KEY (`idGrupo`,`Anio_inicio`),
  ADD KEY `fk_Grupo_Anio1_idx` (`Anio_inicio`);

--
-- Indexes for table `grupo_has_asignaturas`
--
ALTER TABLE `grupo_has_asignaturas`
  ADD PRIMARY KEY (`Grupo_idGrupo`,`Asignaturas_idAsignaturas`),
  ADD KEY `fk_Grupo_has_Asignaturas_Asignaturas1_idx` (`Asignaturas_idAsignaturas`),
  ADD KEY `fk_Grupo_has_Asignaturas_Grupo1_idx` (`Grupo_idGrupo`);
...
ALTER TABLE `permisos`
  ADD PRIMARY KEY (`idPermisos`,`Objeto_idObjeto`,`Ambitos_idAmbitos`),
  ADD KEY `fk_Permisos_Objeto1_idx` (`Objeto_idObjeto`),
  ADD KEY `fk_Permisos_Ambitos1_idx` (`Ambitos_idAmbitos`);
...
ALTER TABLE `profesores_has_grupo`
  ADD PRIMARY KEY (`Profesores_niu`,`Grupo_idGrupo`,`Grupo_Anio_inicio`),
  ADD KEY `fk_Profesores_has_Grupo_Profesores1_idx` (`Profesores_niu`),
  ADD KEY `fk_Profesores_has_Grupo_Grupo1_idx` (`Grupo_idGrupo`,`Grupo_Anio_inicio`);
...
--
ALTER TABLE `ambitos`
  MODIFY `idAmbitos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `cargos`
--
ALTER TABLE `cargos`
  MODIFY `idCargos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `objeto`
  MODIFY `idObjeto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `permisos`
--
ALTER TABLE `permisos`
  MODIFY `idPermisos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=217;
...
--
-- Constraints for table `asignaturas_has_estudios`
--
ALTER TABLE `asignaturas_has_estudios`
...
--
-- Constraints for table `cargos_has_profesores`
--
ALTER TABLE `cargos_has_profesores`
...
--
-- Constraints for table `departamentos_has_profesores`
--
ALTER TABLE `departamentos_has_profesores`
...
--
-- Constraints for table `grupo_has_asignaturas`
--
ALTER TABLE `grupo_has_asignaturas`
...
--
-- Constraints for table `profesores_has_grupo`
--
ALTER TABLE `profesores_has_grupo`
